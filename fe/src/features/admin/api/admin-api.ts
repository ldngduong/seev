...
import type { AdminDashboard, AdminUser, AdminUserDetail, CrawlRun, CrawlRunDetail, ExternalQuota, NewAccountCreditsSetting, PageResponse, QueueOverview, ServiceProduct } from '../types/admin.types'
...
export async function getCrawlRuns(page = 1) { return (await apiClient.get<PageResponse<CrawlRun>>('/admin/crawls', { params: { page } })).data }
